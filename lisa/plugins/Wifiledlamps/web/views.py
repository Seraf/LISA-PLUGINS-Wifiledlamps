...
from lisa.plugins.Wifiledlamps.modules.wifiledlamps import Wifiledlamps

# Template system will be fixed with Django 1.7. Each plugin will be able to have his own templates
@login_required()
def index(request):

    return render_to_response(os.path.abspath(os.path.dirname(__file__) + '/templates/wifiledlamps-index.html'),
                              {
                                  'content': 'test'
                              },
